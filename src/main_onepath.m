...
while ( abs(x_new(2*num_path,1,1)-xf(1)) > lr ) || ( abs(x_new(2*num_path,2,1)-xf(2)) > lr )
    ...
    if Show_Steps == 1
        ...
        if color_bar == 1
            colorbar('southoutside','Ticks',[0,0.20,0.4,0.6,0.8,1],'TickLabels',{'V_{min}, 10 m/s','11 m/s','12 m/s','13 m/s','14 m/s','V_{max},15 m/s'},'fontsize',6);
        end
